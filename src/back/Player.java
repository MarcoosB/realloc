...
public class Player extends User{
    ...
    public HashmapHandler<LogrosTitle, Logro> getLogros(){return logros;}

    public void setLogros(HashmapHandler<LogrosTitle, Logro> logros) {
        this.logros = logros;
    }

    public void setPuntoGuardado(Integer puntoGuardado){this.puntoGuardado=puntoGuardado;}
    ...
    public Integer getPuntoGuardado() {
